...
btnResult.addEventListener("click", function(){
    ...
    if(biman < 18.5) {
        ...
        txtResultNum.textContent = biman;
        txtResultTxt.textContent = "저체중 입니다. 삼겹살을 권합니다.";
        
    } else if(biman < 23) {
        // alert("정상 입니다. 이대로 쭉...");
        txtResult.style.display="flex";
        txtResultNum.textContent = biman;
        txtResultTxt.textContent = "정상 입니다. 이대로 쭉...";
    } else if(biman < 25) {    
        // alert("과체중 입니다. 좀만 덜 드시면 무병장수...");
        txtResult.style.display="flex";
        txtResultNum.textContent = biman;
        txtResultTxt.textContent = "과체중 입니다. 좀만 덜 드시면 무병장수...";
    } else {
        txtResult.style.display="flex";
        txtResultNum.textContent = biman;
        txtResultTxt.textContent = "언제 죽어도 모른다는....";
    }
});
